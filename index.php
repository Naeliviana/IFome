  ...
  <header>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">Exemplo de preço</span>
      </a>

      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Recursos</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Empreendimento</a>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      <h1 class="display-4 fw-normal">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Bem vindo ao nosso site.</h1>
        <p>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg btn-outline-primary">Cadastre-se gratuitamente</button>
          </div>
        </div>
      </div>
      <div class="col">
      ...
      <table class="table text-center">
        <thead>
          <tr>
            ...
            <th style="width: 22%;">Pró</th>
            <th style="width: 22%;">Empreendimento</th>
          </tr>
        </thead>
        <tbody>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            <th scope="row" class="text-start">Compartilhe</th>
            <td></td>
            <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
            <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
          </tr>
    ...
    <div class="row">
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Coisas legais</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Recurso aleatório</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Recurso de equipe</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Coisas para desenvolvedores</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Outro</a></li>
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Última vez</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
        <h5>Recursos</h5>
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li class="mb-1"><a class="link-secondary text-decoration-none" href="#">Localizações</a></li>
